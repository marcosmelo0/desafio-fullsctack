  ...
  return (
    <>
      <main className="bg-gradient-to-br from-blue-950 via-blue-900 to-blue-950 h-screen">
        <div className="w-[90%] ml-[5%] mt-[10vh] rounded-[10px] bg-white h-auto absolute">
          ...
          <form
            ...
            className="w-[90%] ml-[5%] border-gray-300 rounded-[10px] mt-5 p-3 mb-5 border-2 flex flex-col gap-2"
          >
            ...
            <input
              ...
              {...register("name")}
              />
              {errors && <span className="text-red-600 text-[17px]">{errors.name?.message}</span>}
            ...
            <input
              ...
              {...register("email")}
            />
            {errors && <span className="text-red-600 text-[17px]">{errors.email?.message}</span>}
            ...
            <input
              ...
              {...register("password")}
            />
            {errors && <span className="text-red-600 text-[17px]">{errors.password?.message}</span>}
            ...
            <input
              ...
              />
            {errors && <span className="text-red-600 text-[17px]">{errors.confirmPassword?.message}</span>}
            ...
            <input  
              ...
              {...register("telephone")}
              />
              {errors && <span className="text-red-600 text-[17px]">{errors.telephone?.message}</span>}
            <button
              type="submit"
